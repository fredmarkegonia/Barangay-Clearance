...
<?php
  ...
  if(isset($_POST['save'])){
    ...
    $insert_information = "INSERT INTO  `person`(`persons_id`,`firstname`, `middlename`, `lastname`, `status`, `address`, `birth_date`, `barangay_id`) VALUES ('$persons_id','$firstname', '$middlename','$lastname','$status','$address','$birth_date','$barangay_id')";
		 ...
		 <form class="needs-validation" action="" method='post'>
  			<div class="form-row">
  				...
  				<div class="col-md-4 mb-3">
				      ...
				      <input name="firstname" type="text" class="form-control"  id="validationCustom05" placeholder="First Name" value="" required>
    			</div>
    			<div class="col-md-4 md-3">
	      			<label for="validationCustom04">Middle Name</label>
	      			<input name="middlename" type="text" class="form-control" id="validationCustom01" placeholder="Middle name"  autofocus required>
    			</div>
    		</div>
    			<div class="col-md-4 md-3">
