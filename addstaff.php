...
<?php
  ...
  if(isset($_POST['save'])){
    ...
    $insert_information = "INSERT INTO  `staff`(`staff_id`, `first_name1`, `middle_name`, `last_name`,  `barangay_id` , `username`, `password`) VALUES ('$staff_id','$first_name1', '$middle_name','$last_name','$barangay_id','$username','$password')";
